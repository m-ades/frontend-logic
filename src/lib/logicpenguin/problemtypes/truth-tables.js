...
export default class TruthTable extends LogicPenguinProblem {
    ...
    addClickCell(tre) {
        const c = addelem('td', tre, {
            innerHTML: '',
            title: 'click to toggle, or press T/F',
            myprob: this,
            onclick: function() {
    ...
    makeProblem(problem, options, checksave) {
        ...
        addelem('a', this.rnchoosediv, { innerHTML: 'go',
            classes: ['fakebutton'] });
...
if (window) {
    window.addEventListener('keydown', function(e) {
        ...
        if (k == 'T') {
            window.currentClickCell.innerHTML = 'T';
        }
        if (k == 'F') {
            window.currentClickCell.innerHTML = 'F';
        }
        if (k == 'F') {
            window.currentClickCell.innerHTML = 'F';
        }
